      ...
      <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 bg-stone-100">
        <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex">
              <li className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-blue-600">
                <Link href="/">Home</Link>
              </li>
            </div>
            <div className="flex">
            ...
            <div className="flex">
              <li className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-blue-600 cursor-pointer">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex">
              ...
              <a
                ...
                title="Our phone"
                className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-blue-600"
              >
                {info[0]?.phoneNo}
              </a>
            </div>
            ...
            <div className="flex">
              ...
              <a
                ...
                title="Our address"
                className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-blue-600 cursor-pointer"
              >
                {info[0]?.address}
              </a>
            </div>
          ...
          <div>
            ...
            <div className="flex items-center mt-1 space-x-3">
              <a
                ...
                className="text-gray-500 transition-colors duration-300 hover:text-blue-600 cursor-pointer"
              >
